 ...
 * The value is the latest element generated with the function, settings for the component, and the component function itself.
 * It is recommended that you do not modify this directly.
 */
export const Components: Map<
    string,
    { fn: Component; el: HTMLElement; settings: ComponentSettings }
> = new Map();
 ...
 * @param dynamic (for ssr only) - determines if elements need to be re-rendered by rhea during ssr hydration
 * @param elements The components to register.
 */
export const register = (dynamic = false, ...elements: Component[]) => {
    return elements
        .map(element => {
